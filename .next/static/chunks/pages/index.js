...
function IndexPage() {
  ...
  var _useAuthState = (0,_context_auth__WEBPACK_IMPORTED_MODULE_1__.useAuthState)(),
      isAuthenticated = _useAuthState.isAuthenticated,
      user = _useAuthState.user;

  var _useAuthDispatch = (0,_context_auth__WEBPACK_IMPORTED_MODULE_1__.useAuthDispatch)(),
      login = _useAuthDispatch.login,
      register = _useAuthDispatch.register,
      createUser = _useAuthDispatch.createUser,
...
_s(IndexPage, "6dcinHHb8dxDejqM4sI2j2Od6dc=", false, function () {
  return [_context_auth__WEBPACK_IMPORTED_MODULE_1__.useAuthState, _context_auth__WEBPACK_IMPORTED_MODULE_1__.useAuthDispatch];
});
